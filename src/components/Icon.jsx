...
const icons = {
  ...
  'strikethrough': (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17.3 4.9c-2.3-.6-4.4-1-6.2-.9-2.7 0-5.3.7-5.3 3.6 0 1.5 1.1 3.3 5.3 4.3"></path>
      <path d="M4 12h16"></path>
      <path d="M6.7 19.1c2.3.6 4.4 1 6.2.9 2.7 0 5.3-.7 5.3-3.6 0-1.2-.7-2.5-2.6-3.4"></path>
    </svg>
  ),
  'list-ordered': (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function Icon({ name, className, size = 16, style }) {
  ...
  return (
    <span 
      ...
      style={isCustomSize ? { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', ...style } : { width: size, height: size, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', ...style }}
    >
